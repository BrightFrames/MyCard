        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/admin" element={<AdminLayout />}>
              ...
              <Route path="settings" element={<div className="p-8">General Settings (Dummy)</div>} />
              <Route path="email-templates" element={<div className="p-8">Email Templates (Dummy)</div>} />
              <Route path="currencies" element={<div className="p-8">Currencies Management (Dummy)</div>} />
              <Route path="backups" element={<div className="p-8">System Backups (Dummy)</div>} />
              <Route path="clear-cache" element={<div className="p-8">Cache Management (Dummy)</div>} />
              <Route path="updates" element={<div className="p-8">Software Updates (Dummy)</div>} />
              <Route path="account" element={<div className="p-8">My Admin Account (Dummy)</div>} />
            </Route>
